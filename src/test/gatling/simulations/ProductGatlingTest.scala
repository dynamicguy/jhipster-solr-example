...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "url":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "status":null, "inStock":null, "price":null, "keywords":"SAMPLE_TEXT", "features":"SAMPLE_TEXT", "popularity":null, "location":"SAMPLE_TEXT", "manufactureDate":"2020-01-01T00:00:00.000Z", "image":null, "weight":null, "sku":"SAMPLE_TEXT", "includes":"SAMPLE_TEXT", "incubationDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
